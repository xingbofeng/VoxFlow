...
- VoxFlow 现同时提供 macOS、Windows 与 iOS 版本，并通过同一条发布流水线生成三平台安装包。
...
- `CFBundleVersion`：26
- macOS DMG：`VoxFlow-1.15.0-macOS.dmg`
- Windows 安装包：`VoxFlow-1.15.0-windows-x64-setup.exe`
- Windows 便携包：`VoxFlow-1.15.0-windows-x64-portable.zip`
- iOS Ad Hoc IPA：`Mashangxie-1.15.0-iOS.ipa`
