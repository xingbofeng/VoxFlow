...
VoxFlow は、いま使っているアプリの中に留まる音声入力ツールです。音声アシスタントではありません。ウィンドウを奪ったり、別の入力欄へ移動したり、Enter を押したり、自動送信したりしません。

まず音声キーボードであり、作業中に生まれる音声、スクリーンショット、画面収録、クリップボード、ノート、ローカル coding-agent への指示を検索可能な資産として扱います。
