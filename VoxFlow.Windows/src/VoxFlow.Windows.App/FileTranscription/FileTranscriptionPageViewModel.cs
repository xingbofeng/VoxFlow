...
public sealed class FileTranscriptionPageViewModel : INotifyPropertyChanged
{
    ...
    public async ValueTask<bool> DeleteSelectedAsync(CancellationToken cancellationToken)
    {
        ...
        {
            SetFeedback("FileTranscriptionFeedbackDeleteFailed", isError: true);
            return false;
        }
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            SetFeedback("FileTranscriptionFeedbackTranslationFailed", isError: true);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                playbackJobId = null;
                playbackState = FileTranscriptionPlaybackState.Failed;
    ...
    internal void ReportActionFailure(string feedbackKey) =>
        SetFeedback(feedbackKey, isError: true);
