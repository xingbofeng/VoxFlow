...
- Agent JSONL events, persisted trace/NDJSON, SQLite migration SQL, textual UI
  snapshot fixtures, process-launch source, and startup/crash diagnostics. Binary
  UI captures and SQLite databases are rejected from release inputs outright.
