...
| ID | Requirement | OpenSpec tasks | Automated evidence |
| --- | --- | --- | --- |
| WSC-01 | Unified screenshot entry and workflow exclusion | 9.1–9.4 | `VoxFlow.Windows.App.Tests/WindowsScreenshotControllerTests`; `VoxFlow.Windows.Platform.Tests/InteractiveHotkeyRouteTests` |
| WSC-02 | DX11 multi-display frozen capture | 1.1–1.3, 3.1–3.6 | `VoxFlow.Windows.Platform.Tests/Dx11ScreenshotFrameSourceTests` |
| WSC-03 | Physical-pixel mixed-DPI mapping | 2.1–2.2, 3.4, 4.1 | `VoxFlow.Windows.Domain.Tests/ScreenshotGeometryTests`; `VoxFlow.Windows.Platform.Tests/ScreenshotCaptureGeometryTests`; real Windows acceptance matrix |
| WSC-04 | Window snap and complete selection interaction | 2.3–2.6, 3.7–4.6 | `VoxFlow.Windows.Domain.Tests/ScreenshotSelectionTests`; `VoxFlow.Windows.App.Tests/ScreenshotOverlayInputTests` |

## windows-screenshot-annotation-export

| ID | Requirement | OpenSpec tasks | Automated evidence |
| --- | --- | --- | --- |
| WSA-01 | Complete non-deferred annotation tool set | 5.1–5.8, 6.1–6.3 | `VoxFlow.Windows.Domain.Tests/ScreenshotAnnotationTests`; `VoxFlow.Windows.App.Tests/ScreenshotToolbarTests` |
| WSA-02 | Source-resolution rendering and mosaic | 6.3–6.5 | `VoxFlow.Windows.App.Tests/ScreenshotSourceRendererTests` |
| WSA-03 | Image clipboard and PNG export | 6.6–6.8 | `VoxFlow.Windows.App.Tests/ScreenshotClipboardExportTests` |

## windows-screenshot-ocr-transform

| ID | Requirement | OpenSpec tasks | Automated evidence |
| --- | --- | --- | --- |
| WSO-01 | Local five-language OCR and line bounding boxes | 7.1–7.2 | `VoxFlow.Windows.Infrastructure.Tests/TesseractScreenshotOcrAdapterTests`; `VoxFlow.Windows.Application.Tests/ScreenshotOcrOrchestratorTests` |
| WSO-02 | Explicit refinement, translation, summary and inline overlay | 7.3–7.5 | `VoxFlow.Windows.Application.Tests/ScreenshotTransformServiceTests`; `VoxFlow.Windows.App.Tests/ScreenshotInlineTranslationTests`; `VoxFlow.Windows.App.Tests/ScreenshotResultViewModelTests`; real Windows acceptance matrix |
| WSO-03 | Thumbnail/expanded result, copy and speech | 7.6–7.8 | `VoxFlow.Windows.App.Tests/ScreenshotResultPresentationTests`; `VoxFlow.Windows.App.Tests/ScreenshotResultViewModelTests` |

## windows-screenshot-media-history

| ID | Requirement | OpenSpec tasks | Automated evidence |
| --- | --- | --- | --- |
| WSM-01 | Atomic screenshot asset and SQLite persistence | 8.1–8.4 | `VoxFlow.Windows.Infrastructure.Tests/ScreenshotRecordRepositoryTests`; `VoxFlow.Windows.Infrastructure.Tests/FileScreenshotAssetStoreTests`; `VoxFlow.Windows.Infrastructure.Tests/ScreenshotSchemaMigrationTests` |
| WSM-02 | Screenshot media search, filters, paging and detail actions | 8.5–8.8 | `VoxFlow.Windows.App.Tests/ScreenshotMediaPageViewModelTests`; `VoxFlow.Windows.App.Tests/ScreenshotDetailViewModelTests` |
| WSM-03 | Five-language, theme, DPI and accessible UI | 6.2, 9.5–9.7, 10.3–10.8 | localization/theme/automation gates and real Windows acceptance matrix |

## Explicit V1 exclusions

| Excluded scope | Enforcement |
| --- | --- |
| Scrolling capture and screen recording | Screenshot workbench deliberately omits long/scroll capture and recording buttons, runtime contracts, media filters, codecs, subtitles, and placeholder routes. |
...
| Notes and task management | No standalone notes/task route, tray command, deep link, or runtime contract in Windows V1. |
