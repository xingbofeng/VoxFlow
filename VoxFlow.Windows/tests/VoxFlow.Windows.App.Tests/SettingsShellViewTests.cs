...
{
    [Fact]
    public async Task Settings_view_uses_a_220_pixel_navigation_and_mac_aligned_scrollable_content_inset()
    {
        await StaWpfTestHost.RunAsync(_ =>
        {
            ...
            Assert.Equal(new Thickness(36, 32, 36, 32), content.Padding);
