...
// Vendored from giellakbd-ios Keyboard/Models/InputContext.swift
// Stripped: No external dependencies (DivvunSpell was only in CursorContext.swift which we don't vendor)
...
extension InputContext {
    @MainActor static func from(proxy: UITextDocumentProxy) -> InputContext {
