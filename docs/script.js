...
const copy = {
  zh: {
    ...
    headlineB: "把声音送到光标。",
    heroCopy: "常驻菜单栏的输入方式。说完松手，中文、英文和技术词直接进入当前应用。",
    ...
    featureLanguageCopy: "首页统计、历史搜索、笔记和词汇表都在一个清爽窗口里，不抢当前输入焦点。",
  ...
  en: {
    ...
    heroCopy: "A menu-bar input method for macOS. Speak, release, and send clean text into the app you are already using.",
    ...
    featureLanguageCopy: "Home stats, searchable history, notes, glossary, and style rules live in one quiet window without stealing the current focus.",
