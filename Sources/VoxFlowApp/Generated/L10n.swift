  ...
  internal enum Localizable {
    ...
    internal enum App {
      ...
      internal enum Startup {
        internal enum StorageFailure {
          ...
          /// Quit
          internal static let quit = L10n.tr("Localizable", "app.startup.storage_failure.quit", fallback: "Quit")
          /// Storage Unavailable
          internal static let title = L10n.tr("Localizable", "app.startup.storage_failure.title", fallback: "Storage Unavailable")
        }
      }
    ...
    internal enum Model {
      ...
      internal enum LlmProvider {
        ...
        internal static let keychainHint = L10n.tr("Localizable", "model.llm_provider.keychain_hint", fallback: "API keys are stored in the local credentials file.")
        /// Address
    ...
    internal enum Notes {
      ...
      internal enum Detail {
        ...
        internal static let continuePrompt = L10n.tr("Localizable", "notes.detail.continue_prompt", fallback: "Continue adding to this note...")
        ...
        /// Manual save
        internal static let manualSave = L10n.tr("Localizable", "notes.detail.manual_save", fallback: "Manual save")
        /// Saved
        ...
        /// Untagged
        internal static let untagged = L10n.tr("Localizable", "notes.detail.untagged", fallback: "Untagged")
      }
    ...
    internal enum Transcribe {
      ...
      internal enum DropArea {
        ...
        internal static let supportedFormats = L10n.tr("Localizable", "transcribe.drop_area.supported_formats", fallback: "Supports MP3, WAV, M4A, MOV, MP4")
      }
      internal enum Error {
        ...
        internal static func unsupportedAudioContainer(_ p1: Any) -> String {
          return L10n.tr("Localizable", "transcribe.error.unsupported_audio_container", String(describing: p1), fallback: "Unable to read audio from %@. Please choose a file with an audio track.")
        }
