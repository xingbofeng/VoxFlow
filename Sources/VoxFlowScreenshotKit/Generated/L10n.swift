...
internal enum ScreenshotL10n {
  internal enum Localizable {
    ...
    internal enum Asr {
      ...
      internal enum Provider {
        ...
        internal enum Volcengine {
          /// Access Token
          internal static let accessToken = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.access_token", fallback: "Access Token")
          /// App ID
          internal static let appId = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.app_id", fallback: "App ID")
          /// Volcengine Configuration
          internal static let configurationTitle = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.configuration_title", fallback: "Volcengine Configuration")
          ...
          internal static let description = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.description", fallback: "Use Doubao streaming ASR 2.0 over WebSocket. Create the speech app at https://console.volcengine.com/speech/app?opt=create, enable the speech service at https://console.volcengine.com/speech/new/setting/activate, then get the App ID, Access Token, and Secret Key from https://console.volcengine.com/speech/service/10038.")
          /// Hide Volcengine credentials
          internal static let hideCredentials = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.hide_credentials", fallback: "Hide Volcengine credentials")
          ...
          internal static let privacyNote = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.privacy_note", fallback: "Audio is sent to Volcengine. The App ID, Access Token, and Secret Key are stored in local credentials and can be shown or hidden with the eye button.")
          /// Secret Key
          internal static let secretKey = ScreenshotL10n.tr("Localizable", "asr.provider.volcengine.secret_key", fallback: "Secret Key")
    ...
    internal enum Common {
      /// Close
      internal static let close = ScreenshotL10n.tr("Localizable", "common.close", fallback: "Close")
    }
    ...
    internal enum Debug {
      internal enum TranscriptInjection {
        ...
        internal static let defaultText = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.default_text", fallback: "Generate an HTML file.")
        /// Enter simulated transcript
        internal static let placeholder = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.placeholder", fallback: "Enter simulated transcript")
        /// Run
        internal static let run = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.run", fallback: "Run")
        /// Only ASR output is replaced; the downstream task pipeline runs for real.
        internal static let subtitle = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.subtitle", fallback: "Only ASR output is replaced; the downstream task pipeline runs for real.")
        /// Inject Transcript
        internal static let title = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.title", fallback: "Inject Transcript")
        internal enum Mode {
          /// Agent Compose
          internal static let agentCompose = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.mode.agent_compose", fallback: "Agent Compose")
          /// Dictation
          internal static let dictation = ScreenshotL10n.tr("Localizable", "debug.transcript_injection.mode.dictation", fallback: "Dictation")
        }
      }
    }
    internal enum Dictation {
    ...
    internal enum Home {
      ...
      internal enum AgentActionDetail {
        /// Input
        internal static let inputTokens = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.input_tokens", fallback: "Input")
        /// Output
        internal static let outputTokens = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.output_tokens", fallback: "Output")
        /// Generated Result
        internal static let result = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.result", fallback: "Generated Result")
        /// Screen Context
        internal static let screenContext = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.screen_context", fallback: "Screen Context")
        /// Preview Screen Context
        internal static let screenContextPreview = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.screen_context_preview", fallback: "Preview Screen Context")
        /// Review the voice command, screen context, and result
        internal static let subtitle = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.subtitle", fallback: "Review the voice command, screen context, and result")
        /// View Details
        internal static let title = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.title", fallback: "View Details")
        /// Voice Command
        internal static let voiceCommand = ScreenshotL10n.tr("Localizable", "home.agent_action_detail.voice_command", fallback: "Voice Command")
      }
      internal enum Assets {
        ...
        /// Source
        internal static let sourceFilter = ScreenshotL10n.tr("Localizable", "home.assets.source_filter", fallback: "Source")
        /// All Sources
        internal static let sourceFilterAll = ScreenshotL10n.tr("Localizable", "home.assets.source_filter_all", fallback: "All Sources")
        /// Assets
        internal static let title = ScreenshotL10n.tr("Localizable", "home.assets.title", fallback: "Assets")
        /// Type
        internal static let typeFilter = ScreenshotL10n.tr("Localizable", "home.assets.type_filter", fallback: "Type")
        /// All Types
        internal static let typeFilterAll = ScreenshotL10n.tr("Localizable", "home.assets.type_filter_all", fallback: "All Types")
      }
      ...
      internal enum Detail {
        ...
        internal enum AgentAction {
          /// Artifacts
          internal static let artifacts = ScreenshotL10n.tr("Localizable", "home.detail.agent_action.artifacts", fallback: "Artifacts")
          /// No file or folder artifacts were detected.
          internal static let artifactsEmpty = ScreenshotL10n.tr("Localizable", "home.detail.agent_action.artifacts_empty", fallback: "No file or folder artifacts were detected.")
          /// Action log
          internal static let events = ScreenshotL10n.tr("Localizable", "home.detail.agent_action.events", fallback: "Action log")
          /// Model
          internal static let model = ScreenshotL10n.tr("Localizable", "home.detail.agent_action.model", fallback: "Model")
          /// Action result
          internal static let summary = ScreenshotL10n.tr("Localizable", "home.detail.agent_action.summary", fallback: "Action result")
          /// Input %@ · output %@
          internal static func tokensFormat(_ p1: Any, _ p2: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "home.detail.agent_action.tokens_format", String(describing: p1), String(describing: p2), fallback: "Input %@ · output %@")
          }
        }
        internal enum Asr {
          /// Alibaba Cloud ASR
        ...
        internal enum Dispatch {
          /// Target assistant
          internal static let agent = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.agent", fallback: "Target assistant")
          /// Awaiting selection
          internal static let awaitingChoice = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.awaiting_choice", fallback: "Awaiting selection")
          /// Copied instead
          internal static let clipboardFallback = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.clipboard_fallback", fallback: "Copied instead")
          /// Default output
          internal static let defaultOutput = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.default_output", fallback: "Default output")
          /// No coding assistant was selected; the text was handled by the normal processing pipeline.
          internal static let defaultOutputDetail = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.default_output_detail", fallback: "No coding assistant was selected; the text was handled by the normal processing pipeline.")
          ...
          /// Exact match
          internal static let exactMatch = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.exact_match", fallback: "Exact match")
          /// Dispatch failed
          internal static let failed = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.failed", fallback: "Dispatch failed")
          /// Sent to assistant
          internal static let sent = ScreenshotL10n.tr("Localizable", "home.detail.dispatch.sent", fallback: "Sent to assistant")
          /// Sent to %@.
          internal static func sentToFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "home.detail.dispatch.sent_to_format", String(describing: p1), fallback: "Sent to %@.")
          }
          /// Dispatch Result
        ...
        internal enum Meta {
          ...
          /// Window Title
          internal static let windowTitle = ScreenshotL10n.tr("Localizable", "home.detail.meta.window_title", fallback: "Window Title")
        }
        internal enum Pipeline {
          ...
          internal enum Step {
            /// Action
            internal static let agentAction = ScreenshotL10n.tr("Localizable", "home.detail.pipeline.step.agent_action", fallback: "Action")
            /// ASR
            ...
            /// Dispatch
            internal static let dispatch = ScreenshotL10n.tr("Localizable", "home.detail.pipeline.step.dispatch", fallback: "Dispatch")
            /// LLM correction
        ...
        internal enum RefinementGuard {
          /// Baseline
          internal static let baseline = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.baseline", fallback: "Baseline")
          /// Fallback
          internal static let fallback = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.fallback", fallback: "Fallback")
          /// Protected tokens
          internal static let protectedTokens = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.protected_tokens", fallback: "Protected tokens")
          /// Reason
          internal static let reason = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason", fallback: "Reason")
          /// Similarity
          internal static let similarity = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.similarity", fallback: "Similarity")
          /// %d%%
          internal static func similarityFormat(_ p1: Int) -> String {
            return ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.similarity_format", p1, fallback: "%d%%")
          }
          /// Refinement Guard
          internal static let title = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.title", fallback: "Refinement Guard")
          internal enum Decision {
            /// Passed
            internal static let accepted = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.decision.accepted", fallback: "Passed")
            /// Rejected
            internal static let rejected = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.decision.rejected", fallback: "Rejected")
          }
          internal enum Fallback {
            /// Recognition raw text
            internal static let asrRaw = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.fallback.asr_raw", fallback: "Recognition raw text")
            /// Pre-correction text
            internal static let preLlmDeterministic = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.fallback.pre_llm_deterministic", fallback: "Pre-correction text")
          }
          internal enum Reason {
            /// Output looks like an answer instead of cleaned speech
            internal static let answerLikeOutput = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.answer_like_output", fallback: "Output looks like an answer instead of cleaned speech")
            /// Empty model output
            internal static let emptyOutput = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.empty_output", fallback: "Empty model output")
            /// Output looks like an explanation instead of cleaned speech
            internal static let explanationLikeOutput = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.explanation_like_output", fallback: "Output looks like an explanation instead of cleaned speech")
            /// Output diverges too far from the spoken text
            internal static let normalizedSimilarityLow = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.normalized_similarity_low", fallback: "Output diverges too far from the spoken text")
            /// Output expands well beyond the spoken text
            internal static let obviousExpansion = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.obvious_expansion", fallback: "Output expands well beyond the spoken text")
            /// Output dropped a protected token (URL, version, path, email, or code)
            internal static let protectedTokenMissing = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.protected_token_missing", fallback: "Output dropped a protected token (URL, version, path, email, or code)")
            /// Output injected too many context hotwords
            internal static let tooManyHotwords = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.reason.too_many_hotwords", fallback: "Output injected too many context hotwords")
          }
          internal enum TokenKind {
            /// Code identifier
            internal static let codeIdentifier = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.code_identifier", fallback: "Code identifier")
            /// Code span
            internal static let codeSpan = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.code_span", fallback: "Code span")
            /// Email
            internal static let email = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.email", fallback: "Email")
            /// Number
            internal static let numeric = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.numeric", fallback: "Number")
            /// Path
            internal static let path = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.path", fallback: "Path")
            /// URL
            internal static let url = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.url", fallback: "URL")
            /// Version
            internal static let version = ScreenshotL10n.tr("Localizable", "home.detail.refinement_guard.token_kind.version", fallback: "Version")
          }
        }
        ...
        internal enum Status {
          ...
          /// Processing
          internal static let processing = ScreenshotL10n.tr("Localizable", "home.detail.status.processing", fallback: "Processing")
          /// Success
        ...
        internal enum Trace {
          ...
          internal static let missingAgentDispatch = ScreenshotL10n.tr("Localizable", "home.detail.trace.missing_agent_dispatch", fallback: "This AI Coding record has no complete processing trace; the voice command and dispatch result are still available.")
        ...
        internal enum Warning {
          ...
          internal static let llmRefinementRejected = ScreenshotL10n.tr("Localizable", "home.detail.warning.llm_refinement_rejected", fallback: "The model rewrite did not pass safety checks, so a safe fallback text was used.")
    ...
    internal enum Hud {
      ...
      internal enum AgentCompose {
        ...
        /// Done
        internal static let runtimeCompleted = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_completed", fallback: "Done")
        /// Task completed
        internal static let runtimeCompletedDetail = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_completed_detail", fallback: "Task completed")
        /// Failed
        internal static let runtimeFailed = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_failed", fallback: "Failed")
        /// Task failed
        internal static let runtimeFailedDetail = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_failed_detail", fallback: "Task failed")
        /// Operating...
        internal static let runtimeOperating = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_operating", fallback: "Operating...")
        /// Running the current action
        internal static let runtimeOperatingDetail = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_operating_detail", fallback: "Running the current action")
        /// Processing...
        internal static let runtimeProcessing = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_processing", fallback: "Processing...")
        /// Preparing the task summary
        internal static let runtimeProcessingDetail = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_processing_detail", fallback: "Preparing the task summary")
        /// Working on: %@
        internal static func runtimeTaskFormat(_ p1: Any) -> String {
          return ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_task_format", String(describing: p1), fallback: "Working on: %@")
        }
        /// Creating the PPT
        internal static let runtimeTaskPpt = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_task_ppt", fallback: "Creating the PPT")
        /// Waiting for approval...
        internal static let runtimeWaitingPermission = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_waiting_permission", fallback: "Waiting for approval...")
        /// Click to approve, Esc to exit
        internal static let runtimeWaitingPermissionDetail = ScreenshotL10n.tr("Localizable", "hud.agent_compose.runtime_waiting_permission_detail", fallback: "Click to approve, Esc to exit")
        /// Transcribing
    ...
    internal enum Llm {
      ...
      internal enum Refiner {
        internal enum Error {
          ...
          internal static let githubModelsAccess = ScreenshotL10n.tr("Localizable", "llm.refiner.error.github_models_access", fallback: "GitHub Models rejected this model. Use a GitHub token/account with Models access for the selected model, or choose a model available to your account.")
          ...
          internal static let huggingfaceInferencePermission = ScreenshotL10n.tr("Localizable", "llm.refiner.error.huggingface_inference_permission", fallback: "The Hugging Face token can read metadata but cannot call Inference Providers. Create or edit the token and enable the Inference Providers permission.")
          ...
          internal static let opencodeBalance = ScreenshotL10n.tr("Localizable", "llm.refiner.error.opencode_balance", fallback: "OpenCode Zen rejected the request because the account balance is insufficient. Add billing credit, then test again.")
        }
      }
    ...
    internal enum Menu {
      internal enum Main {
        ...
        /// Support
        internal static let help = ScreenshotL10n.tr("Localizable", "menu.main.help", fallback: "Support")
        /// Hide VoxFlow
        ...
        /// Stop Dictation
        internal static let stopDictation = ScreenshotL10n.tr("Localizable", "menu.main.stop_dictation", fallback: "Stop Dictation")
        /// Undo
      ...
      internal enum Status {
        /// Agent Model
        internal static let agentModel = ScreenshotL10n.tr("Localizable", "menu.status.agent_model", fallback: "Agent Model")
        /// No Agent model configured
        internal static let agentModelUnavailable = ScreenshotL10n.tr("Localizable", "menu.status.agent_model_unavailable", fallback: "No Agent model configured")
        /// ASR Models
    ...
    internal enum Model {
      ...
      internal enum LlmProvider {
        ...
        /// Fetch models
        internal static let fetchModels = ScreenshotL10n.tr("Localizable", "model.llm_provider.fetch_models", fallback: "Fetch models")
        /// API key
        internal static let fieldApiKey = ScreenshotL10n.tr("Localizable", "model.llm_provider.field_api_key", fallback: "API key")
        /// API key
        internal static let fieldApiKeyOptional = ScreenshotL10n.tr("Localizable", "model.llm_provider.field_api_key_optional", fallback: "API key")
        /// API key *
        internal static let fieldApiKeyRequired = ScreenshotL10n.tr("Localizable", "model.llm_provider.field_api_key_required", fallback: "API key *")
        /// API key %@
        ...
        /// Choose from list
        internal static let modelChooseFromList = ScreenshotL10n.tr("Localizable", "model.llm_provider.model_choose_from_list", fallback: "Choose from list")
        /// Fetch the model list after entering the URL and API key.
        internal static let modelListHint = ScreenshotL10n.tr("Localizable", "model.llm_provider.model_list_hint", fallback: "Fetch the model list after entering the URL and API key.")
        /// %d models available
        internal static func modelListLoadedFormat(_ p1: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "model.llm_provider.model_list_loaded_format", p1, fallback: "%d models available")
        }
        /// Enter manually
        internal static let modelManualEntry = ScreenshotL10n.tr("Localizable", "model.llm_provider.model_manual_entry", fallback: "Enter manually")
        /// Choose a model
        internal static let modelPickerPlaceholder = ScreenshotL10n.tr("Localizable", "model.llm_provider.model_picker_placeholder", fallback: "Choose a model")
        /// This local service can be used without an API key.
        internal static let noApiKeyHint = ScreenshotL10n.tr("Localizable", "model.llm_provider.no_api_key_hint", fallback: "This local service can be used without an API key.")
        /// No key required
        internal static let noApiKeyRequired = ScreenshotL10n.tr("Localizable", "model.llm_provider.no_api_key_required", fallback: "No key required")
        /// Open docs
        internal static let openDocs = ScreenshotL10n.tr("Localizable", "model.llm_provider.open_docs", fallback: "Open docs")
        /// %@ (%d models)
        ...
        /// Custom
        internal static let templateCustom = ScreenshotL10n.tr("Localizable", "model.llm_provider.template_custom", fallback: "Custom")
        /// Choose a provider to fill the official URL; Custom keeps your manual settings.
        internal static let templateHint = ScreenshotL10n.tr("Localizable", "model.llm_provider.template_hint", fallback: "Choose a provider to fill the official URL; Custom keeps your manual settings.")
        /// Provider
        internal static let templateLabel = ScreenshotL10n.tr("Localizable", "model.llm_provider.template_label", fallback: "Provider")
        /// Test
        internal static let test = ScreenshotL10n.tr("Localizable", "model.llm_provider.test", fallback: "Test")
        /// Test all
        internal static let testAll = ScreenshotL10n.tr("Localizable", "model.llm_provider.test_all", fallback: "Test all")
        /// No enabled providers are ready to test.
        internal static let testAllEmpty = ScreenshotL10n.tr("Localizable", "model.llm_provider.test_all_empty", fallback: "No enabled providers are ready to test.")
        /// Test all enabled model providers
        internal static let testAllHelp = ScreenshotL10n.tr("Localizable", "model.llm_provider.test_all_help", fallback: "Test all enabled model providers")
        /// Tested %d providers; %d failed.
        internal static func testAllPartialFailureFormat(_ p1: Int, _ p2: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "model.llm_provider.test_all_partial_failure_format", p1, p2, fallback: "Tested %d providers; %d failed.")
        }
        /// Tested %d providers successfully.
        internal static func testAllSuccessFormat(_ p1: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "model.llm_provider.test_all_success_format", p1, fallback: "Tested %d providers successfully.")
        }
        /// Test connection
        ...
        internal static let toggleEnableHint = ScreenshotL10n.tr("Localizable", "model.llm_provider.toggle_enable_hint", fallback: "Enabled providers can be used by correction, translation, and AI tasks.")
        /// API key
        ...
        internal enum AgentSection {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.agent_section.subtitle", fallback: "Local coding-agent runtimes and model choices used by Agent workflows.")
          /// Agent models
          internal static let title = ScreenshotL10n.tr("Localizable", "model.llm_provider.agent_section.title", fallback: "Agent models")
        }
        internal enum BuiltinAgent {
          /// Built in
          internal static let badge = ScreenshotL10n.tr("Localizable", "model.llm_provider.builtin_agent.badge", fallback: "Built in")
          /// Model source
          internal static let configurationTitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.builtin_agent.configuration_title", fallback: "Model source")
          ...
          internal static let defaultLlmNote = ScreenshotL10n.tr("Localizable", "model.llm_provider.builtin_agent.default_llm_note", fallback: "VoxFlow Agent uses the current default LLM provider above for model calls. This card only selects the built-in agent loop and tool host.")
          /// Check Built-in Agent
          internal static let detect = ScreenshotL10n.tr("Localizable", "model.llm_provider.builtin_agent.detect", fallback: "Check Built-in Agent")
          /// Runs VoxFlow's built-in agent loop with Swift-owned tools. Model requests use your current default LLM provider.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.builtin_agent.subtitle", fallback: "Runs VoxFlow's built-in agent loop with Swift-owned tools. Model requests use your current default LLM provider.")
        }
        internal enum Codex {
          /// Available · %@
          internal static func availableFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.available_format", String(describing: p1), fallback: "Available · %@")
          }
          /// Detect
          internal static let detect = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.detect", fallback: "Detect")
          /// Local Codex runtime is available
          internal static let detectAvailable = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.detect_available", fallback: "Local Codex runtime is available")
          /// Detecting...
          internal static let detecting = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.detecting", fallback: "Detecting...")
          /// Local Codex disabled
          internal static let disabled = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.disabled", fallback: "Local Codex disabled")
          /// Disabled
          internal static let disabledShort = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.disabled_short", fallback: "Disabled")
          /// Local Codex enabled
          internal static let enabled = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.enabled", fallback: "Local Codex enabled")
          /// Enabled
          internal static let enabledShort = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.enabled_short", fallback: "Enabled")
          /// Model
          internal static let modelSection = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.model_section", fallback: "Model")
          /// Not checked
          internal static let notChecked = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.not_checked", fallback: "Not checked")
          /// Uses your signed-in Codex CLI / Codex.app. No API key required.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.subtitle", fallback: "Uses your signed-in Codex CLI / Codex.app. No API key required.")
          /// Local Codex
          internal static let title = ScreenshotL10n.tr("Localizable", "model.llm_provider.codex.title", fallback: "Local Codex")
        }
        internal enum CustomSection {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.custom_section.subtitle", fallback: "OpenAI-compatible services you configure yourself, used for correction, translation, and general AI tasks.")
          /// Custom model services
          internal static let title = ScreenshotL10n.tr("Localizable", "model.llm_provider.custom_section.title", fallback: "Custom model services")
        }
        internal enum LocalAgent {
          /// %@ runtime is available
          internal static func detectAvailableFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.detect_available_format", String(describing: p1), fallback: "%@ runtime is available")
          }
          /// %@ disabled
          internal static func disabledFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.disabled_format", String(describing: p1), fallback: "%@ disabled")
          }
          /// %@ enabled
          internal static func enabledFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.enabled_format", String(describing: p1), fallback: "%@ enabled")
          }
          /// Enter model ID manually
          internal static let manualModelPlaceholder = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.manual_model_placeholder", fallback: "Enter model ID manually")
          /// No matching models
          internal static let noMatchingModels = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.no_matching_models", fallback: "No matching models")
          /// Search or enter model ID
          internal static let searchModelPlaceholder = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.search_model_placeholder", fallback: "Search or enter model ID")
          /// Selected
          internal static let selectedShort = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.selected_short", fallback: "Selected")
          /// Set Default
          internal static let setDefault = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.set_default", fallback: "Set Default")
          /// Uses your signed-in local coding-agent CLI. Detection checks the CLI only and does not call a model.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.subtitle", fallback: "Uses your signed-in local coding-agent CLI. Detection checks the CLI only and does not call a model.")
          /// Not selected
          internal static let unselectedShort = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.unselected_short", fallback: "Not selected")
          /// Use
          internal static let useManualModel = ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.use_manual_model", fallback: "Use")
          /// Use "%@"
          internal static func useSearchModelFormat(_ p1: Any) -> String {
            return ScreenshotL10n.tr("Localizable", "model.llm_provider.local_agent.use_search_model_format", String(describing: p1), fallback: "Use \"%@\"")
          }
        }
      }
    }
    ...
    internal enum Notes {
      internal enum Action {
        /// Cancel
        internal static let cancelEdit = ScreenshotL10n.tr("Localizable", "notes.action.cancel_edit", fallback: "Cancel")
        /// Continue dictation
        internal static let continueDictation = ScreenshotL10n.tr("Localizable", "notes.action.continue_dictation", fallback: "Continue dictation")
        /// Copy
        internal static let copy = ScreenshotL10n.tr("Localizable", "notes.action.copy", fallback: "Copy")
        /// Delete
        internal static let delete = ScreenshotL10n.tr("Localizable", "notes.action.delete", fallback: "Delete")
        /// Done
        internal static let done = ScreenshotL10n.tr("Localizable", "notes.action.done", fallback: "Done")
        /// Edit
        internal static let edit = ScreenshotL10n.tr("Localizable", "notes.action.edit", fallback: "Edit")
        /// Export
        internal static let export = ScreenshotL10n.tr("Localizable", "notes.action.export", fallback: "Export")
        /// Finish
        internal static let finishContinuing = ScreenshotL10n.tr("Localizable", "notes.action.finish_continuing", fallback: "Finish")
        /// More
        internal static let more = ScreenshotL10n.tr("Localizable", "notes.action.more", fallback: "More")
        /// New note
        internal static let newNote = ScreenshotL10n.tr("Localizable", "notes.action.new_note", fallback: "New note")
        /// Save
        internal static let save = ScreenshotL10n.tr("Localizable", "notes.action.save", fallback: "Save")
      }
      ...
      internal enum Feedback {
        /// Note content copied.
        internal static let copied = ScreenshotL10n.tr("Localizable", "notes.feedback.copied", fallback: "Note content copied.")
        /// Created note.
      ...
      internal enum QuickCapture {
        /// Hold to speak
        internal static let holdToSpeakHint = ScreenshotL10n.tr("Localizable", "notes.quick_capture.hold_to_speak_hint", fallback: "Hold to speak")
      }
      ...
      internal enum Source {
        /// File transcription
        internal static let fileTranscription = ScreenshotL10n.tr("Localizable", "notes.source.file_transcription", fallback: "File transcription")
        /// Dictation
        internal static let history = ScreenshotL10n.tr("Localizable", "notes.source.history", fallback: "Dictation")
        /// Manual
        internal static let manual = ScreenshotL10n.tr("Localizable", "notes.source.manual", fallback: "Manual")
      }
      internal enum View {
        /// Close preview
    ...
    internal enum Palette {
      ...
      internal enum FileAction {
        /// Copy Name
        internal static let copyName = ScreenshotL10n.tr("Localizable", "palette.file_action.copy_name", fallback: "Copy Name")
        /// Copy Path
        internal static let copyPath = ScreenshotL10n.tr("Localizable", "palette.file_action.copy_path", fallback: "Copy Path")
        /// Open
        internal static let `open` = ScreenshotL10n.tr("Localizable", "palette.file_action.open", fallback: "Open")
        /// Quick Look
        internal static let quickLook = ScreenshotL10n.tr("Localizable", "palette.file_action.quick_look", fallback: "Quick Look")
        /// Show in Finder
        internal static let showInFinder = ScreenshotL10n.tr("Localizable", "palette.file_action.show_in_finder", fallback: "Show in Finder")
      }
      internal enum Files {
        /// No files found
        internal static let empty = ScreenshotL10n.tr("Localizable", "palette.files.empty", fallback: "No files found")
        internal enum Kind {
          /// File
          internal static let file = ScreenshotL10n.tr("Localizable", "palette.files.kind.file", fallback: "File")
          /// Folder
          internal static let folder = ScreenshotL10n.tr("Localizable", "palette.files.kind.folder", fallback: "Folder")
        }
        internal enum Metadata {
          /// Created
          internal static let created = ScreenshotL10n.tr("Localizable", "palette.files.metadata.created", fallback: "Created")
          /// Kind
          internal static let kind = ScreenshotL10n.tr("Localizable", "palette.files.metadata.kind", fallback: "Kind")
          /// Loading details
          internal static let loading = ScreenshotL10n.tr("Localizable", "palette.files.metadata.loading", fallback: "Loading details")
          /// Modified
          internal static let modified = ScreenshotL10n.tr("Localizable", "palette.files.metadata.modified", fallback: "Modified")
          /// Name
          internal static let name = ScreenshotL10n.tr("Localizable", "palette.files.metadata.name", fallback: "Name")
          /// Size
          internal static let size = ScreenshotL10n.tr("Localizable", "palette.files.metadata.size", fallback: "Size")
          /// Where
          internal static let `where` = ScreenshotL10n.tr("Localizable", "palette.files.metadata.where", fallback: "Where")
        }
        internal enum Section {
          /// Partial Results
          internal static let partial = ScreenshotL10n.tr("Localizable", "palette.files.section.partial", fallback: "Partial Results")
          /// Recent Files
          internal static let recent = ScreenshotL10n.tr("Localizable", "palette.files.section.recent", fallback: "Recent Files")
          /// Results
          internal static let results = ScreenshotL10n.tr("Localizable", "palette.files.section.results", fallback: "Results")
          /// Searching
          internal static let searching = ScreenshotL10n.tr("Localizable", "palette.files.section.searching", fallback: "Searching")
        }
      }
      internal enum Filter {
        /// All types
      ...
      internal enum RootItem {
        ...
        internal enum Subtitle {
          ...
          internal static let searchFiles = ScreenshotL10n.tr("Localizable", "palette.root_item.subtitle.search_files", fallback: "Find local files by name")
        ...
        internal enum Title {
          ...
          /// Search Files
          internal static let searchFiles = ScreenshotL10n.tr("Localizable", "palette.root_item.title.search_files", fallback: "Search Files")
          /// Start Dictation
      ...
      internal enum Search {
        ...
        /// Search files...
        internal static let filesPlaceholder = ScreenshotL10n.tr("Localizable", "palette.search.files_placeholder", fallback: "Search files...")
        /// Search...
    ...
    internal enum Settings {
      ...
      internal enum Destination {
        /// Smart Workbench
        internal static let agent = ScreenshotL10n.tr("Localizable", "settings.destination.agent", fallback: "Smart Workbench")
        /// General
        internal static let general = ScreenshotL10n.tr("Localizable", "settings.destination.general", fallback: "General")
        /// Models
        internal static let models = ScreenshotL10n.tr("Localizable", "settings.destination.models", fallback: "Models")
        /// Screenshot
        internal static let screenshot = ScreenshotL10n.tr("Localizable", "settings.destination.screenshot", fallback: "Screenshot")
        /// Text
        internal static let text = ScreenshotL10n.tr("Localizable", "settings.destination.text", fallback: "Text")
        /// Selection Assistant
        internal static let translation = ScreenshotL10n.tr("Localizable", "settings.destination.translation", fallback: "Selection Assistant")
        /// Voice
        internal static let voice = ScreenshotL10n.tr("Localizable", "settings.destination.voice", fallback: "Voice")
        internal enum Screenshot {
          /// Configure screenshot and clipboard OCR behavior.
          internal static let behaviorSubtitle = ScreenshotL10n.tr("Localizable", "settings.destination.screenshot.behavior_subtitle", fallback: "Configure screenshot and clipboard OCR behavior.")
          /// Configure screenshot, OCR, and screen capture workflows.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.destination.screenshot.subtitle", fallback: "Configure screenshot, OCR, and screen capture workflows.")
        }
        internal enum Translation {
          /// Configure selected-text shortcuts and actions.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.destination.translation.subtitle", fallback: "Configure selected-text shortcuts and actions.")
        }
      }
      internal enum Error {
      ...
      internal enum General {
        ...
        internal enum AgentCompose {
          ...
          /// Summon Agent
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.general.agent_compose.title", fallback: "Summon Agent")
        }
        internal enum Basics {
          /// Configure appearance, launch, and language behavior.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.general.basics.subtitle", fallback: "Configure appearance, launch, and language behavior.")
          /// Basics
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.general.basics.title", fallback: "Basics")
        }
        internal enum Dictation {
          /// Modify
      ...
      internal enum Models {
        internal enum Agent {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.models.agent.subtitle", fallback: "Configure local Agent runtimes and model choices for Agent Compose.")
          /// Agent
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.models.agent.title", fallback: "Agent")
        }
        internal enum Llm {
          /// Configure LLM providers, API keys, and model names.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.models.llm.subtitle", fallback: "Configure LLM providers, API keys, and model names.")
          /// LLM
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.models.llm.title", fallback: "LLM")
        }
        internal enum Local {
          /// Manage local model behavior and storage.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.models.local.subtitle", fallback: "Manage local model behavior and storage.")
          /// Local Models
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.models.local.title", fallback: "Local Models")
        }
        internal enum Tab {
          /// Agent
          internal static let agent = ScreenshotL10n.tr("Localizable", "settings.models.tab.agent", fallback: "Agent")
          /// ASR
          internal static let asr = ScreenshotL10n.tr("Localizable", "settings.models.tab.asr", fallback: "ASR")
          /// LLM
          internal static let llm = ScreenshotL10n.tr("Localizable", "settings.models.tab.llm", fallback: "LLM")
          /// Local Models
          internal static let localModels = ScreenshotL10n.tr("Localizable", "settings.models.tab.local_models", fallback: "Local Models")
          /// Translation
          internal static let translation = ScreenshotL10n.tr("Localizable", "settings.models.tab.translation", fallback: "Translation")
          /// TTS
          internal static let tts = ScreenshotL10n.tr("Localizable", "settings.models.tab.tts", fallback: "TTS")
        }
      }
      internal enum Output {
        /// Choose how VoxFlow inserts text.
        internal static let groupSubtitle = ScreenshotL10n.tr("Localizable", "settings.output.group_subtitle", fallback: "Choose how VoxFlow inserts text.")
        /// Text insertion
        internal static let groupTitle = ScreenshotL10n.tr("Localizable", "settings.output.group_title", fallback: "Text insertion")
        internal enum AvoidClipboard {
          /// Write text by simulating keyboard input and avoid using the system clipboard when possible.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.output.avoid_clipboard.subtitle", fallback: "Write text by simulating keyboard input and avoid using the system clipboard when possible.")
          /// Simulated keyboard input
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.output.avoid_clipboard.title", fallback: "Simulated keyboard input")
        }
        ...
        internal enum FastPaste {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.output.fast_paste.subtitle", fallback: "Insert by temporarily pasting text. Faster in most apps.")
          /// Fast paste
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.output.fast_paste.title", fallback: "Fast paste")
        }
        internal enum RestoreClipboard {
          /// After fast paste, put your previous clipboard content back.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.output.restore_clipboard.subtitle", fallback: "After fast paste, put your previous clipboard content back.")
          /// Restore clipboard after paste
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.output.restore_clipboard.title", fallback: "Restore clipboard after paste")
        }
        internal enum TextInputMode {
          /// Choose how VoxFlow writes text back into the current input field.
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.output.text_input_mode.subtitle", fallback: "Choose how VoxFlow writes text back into the current input field.")
          /// Input method
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.output.text_input_mode.title", fallback: "Input method")
        }
      }
      ...
      internal enum RestoreDefaults {
        ...
        internal static let action = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.action", fallback: "Restore Default Settings…")
        /// Restore Defaults
        internal static let confirmAction = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.confirm_action", fallback: "Restore Defaults")
        /// Restore Default Settings
        internal static let confirmTitle = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.confirm_title", fallback: "Restore Default Settings")
        ...
        internal static let preservedItems = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.preserved_items", fallback: "• API keys and LLM/ASR/Agent provider configurations\n• Provider default selections\n• History, notes, screenshots, and tasks\n• Vocabulary, hotwords, and learning data\n• Custom styles\n• Downloaded models and cache files")
        /// Will not be affected:
        internal static let preservedSectionTitle = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.preserved_section_title", fallback: "Will not be affected:")
        ...
        internal static let resetItems = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.reset_items", fallback: "• User preferences and shortcuts\n• Audio and recognition language preferences\n• Text processing and voice correction behavior\n• Agent behavior preferences\n• Style auto-matching settings\n• Built-in style prompts, enabled state, and default style")
        /// Will be restored to defaults:
        internal static let resetSectionTitle = ScreenshotL10n.tr("Localizable", "settings.restore_defaults.reset_section_title", fallback: "Will be restored to defaults:")
      }
      internal enum Shortcuts {
        /// Cancel
      ...
      internal enum System {
        ...
        internal enum LocalModelLivePreview {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.system.local_model_live_preview.subtitle", fallback: "Show streaming partial results while speaking with local models.")
          /// Streaming recognition preview
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.system.local_model_live_preview.title", fallback: "Streaming recognition preview")
        }
      }
      internal enum Task {
        ...
        internal enum AgentCli {
          /// vox flow --claude
          internal static let exampleClaude = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.example_claude", fallback: "vox flow --claude")
          /// vox flow --codebuddy
          internal static let exampleCodebuddy = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.example_codebuddy", fallback: "vox flow --codebuddy")
          /// vox flow codex
          internal static let exampleCodex = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.example_codex", fallback: "vox flow codex")
          /// vox flow opencode
          internal static let exampleOpencode = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.example_opencode", fallback: "vox flow opencode")
          /// vox flow pi
          internal static let examplePi = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.example_pi", fallback: "vox flow pi")
          /// Register the bundled vox flow command so terminal agents can receive dictated prompts.
          internal static let intro = ScreenshotL10n.tr("Localizable", "settings.task.agent_cli.intro", fallback: "Register the bundled vox flow command so terminal agents can receive dictated prompts.")
          /// Registered
        ...
        internal enum Selection {
          ...
          internal enum Agent {
            ...
            /// Task Assistant
            internal static let title = ScreenshotL10n.tr("Localizable", "settings.task.selection.agent.title", fallback: "Task Assistant")
          }
          internal enum AskAi {
      ...
      internal enum Workbench {
        internal enum Group {
          ...
          internal static let subtitle = ScreenshotL10n.tr("Localizable", "settings.workbench.group.subtitle", fallback: "Configure the Smart Workbench shortcut and window behavior.")
          /// Workbench
          internal static let title = ScreenshotL10n.tr("Localizable", "settings.workbench.group.title", fallback: "Workbench")
        }
      }
    ...
    internal enum Transcribe {
      ...
      internal enum Action {
        ...
        internal static let browse = ScreenshotL10n.tr("Localizable", "transcribe.action.browse", fallback: "Browse")
        /// ===== Transcribe =====
        ...
        /// Copy completed
        internal static let copyCompleted = ScreenshotL10n.tr("Localizable", "transcribe.action.copy_completed", fallback: "Copy completed")
        /// Delete
        ...
        /// Export
        internal static let export = ScreenshotL10n.tr("Localizable", "transcribe.action.export", fallback: "Export")
        /// Pause
        ...
        /// Save as note
        internal static let saveAsNote = ScreenshotL10n.tr("Localizable", "transcribe.action.save_as_note", fallback: "Save as note")
        /// Select File
        ...
        /// Translate full text
        internal static let translateFullText = ScreenshotL10n.tr("Localizable", "transcribe.action.translate_full_text", fallback: "Translate full text")
      }
      internal enum Delete {
      ...
      internal enum Diagnostic {
        ...
        internal static func failedSegments(_ p1: Any) -> String {
          return ScreenshotL10n.tr("Localizable", "transcribe.diagnostic.failed_segments", String(describing: p1), fallback: "Failed segments: %@")
        }
        /// 30-second segments · prior context · auto-retry on failure
        internal static let summary = ScreenshotL10n.tr("Localizable", "transcribe.diagnostic.summary", fallback: "30-second segments · prior context · auto-retry on failure")
        /// Advanced details
        internal static let toggle = ScreenshotL10n.tr("Localizable", "transcribe.diagnostic.toggle", fallback: "Advanced details")
      }
      ...
      internal enum Error {
        ...
        internal static let partialFailure = ScreenshotL10n.tr("Localizable", "transcribe.error.partial_failure", fallback: "Some segments failed.")
      ...
      internal enum Export {
        /// Bilingual Markdown
        internal static let bilingualMarkdown = ScreenshotL10n.tr("Localizable", "transcribe.export.bilingual_markdown", fallback: "Bilingual Markdown")
        /// Original
        internal static let originalSection = ScreenshotL10n.tr("Localizable", "transcribe.export.original_section", fallback: "Original")
        /// Translated Markdown
        internal static let translatedMarkdown = ScreenshotL10n.tr("Localizable", "transcribe.export.translated_markdown", fallback: "Translated Markdown")
        /// Translation
        internal static let translatedSection = ScreenshotL10n.tr("Localizable", "transcribe.export.translated_section", fallback: "Translation")
        /// Translated TXT
        internal static let translatedTxt = ScreenshotL10n.tr("Localizable", "transcribe.export.translated_txt", fallback: "Translated TXT")
      }
      internal enum Feedback {
        ...
        internal static let partiallyCompleted = ScreenshotL10n.tr("Localizable", "transcribe.feedback.partially_completed", fallback: "Transcription partially completed.")
        ...
        /// Translation completed.
        internal static let translationCompleted = ScreenshotL10n.tr("Localizable", "transcribe.feedback.translation_completed", fallback: "Translation completed.")
        /// Translation failed.
        internal static let translationFailed = ScreenshotL10n.tr("Localizable", "transcribe.feedback.translation_failed", fallback: "Translation failed.")
      }
      internal enum Header {
      ...
      internal enum Metadata {
        /// segments
        internal static let segmentsUnit = ScreenshotL10n.tr("Localizable", "transcribe.metadata.segments_unit", fallback: "segments")
      }
      internal enum ProviderMode {
        /// Native file transcription
        internal static let nativeFile = ScreenshotL10n.tr("Localizable", "transcribe.provider_mode.native_file", fallback: "Native file transcription")
        /// Not recommended for long files
        internal static let notRecommended = ScreenshotL10n.tr("Localizable", "transcribe.provider_mode.not_recommended", fallback: "Not recommended for long files")
        /// Segmented transcription
        internal static let segmented = ScreenshotL10n.tr("Localizable", "transcribe.provider_mode.segmented", fallback: "Segmented transcription")
      }
      internal enum Queue {
        /// No transcription jobs yet.
        internal static let empty = ScreenshotL10n.tr("Localizable", "transcribe.queue.empty", fallback: "No transcription jobs yet.")
        /// Processing segment %d / %d
        internal static func processingSegment(_ p1: Int, _ p2: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "transcribe.queue.processing_segment", p1, p2, fallback: "Processing segment %d / %d")
        }
        /// Queue
        internal static let title = ScreenshotL10n.tr("Localizable", "transcribe.queue.title", fallback: "Queue")
      }
      internal enum Results {
        /// No result yet.
        internal static let empty = ScreenshotL10n.tr("Localizable", "transcribe.results.empty", fallback: "No result yet.")
        /// Result
        internal static let title = ScreenshotL10n.tr("Localizable", "transcribe.results.title", fallback: "Result")
        /// Translation
        internal static let translationSection = ScreenshotL10n.tr("Localizable", "transcribe.results.translation_section", fallback: "Translation")
      }
      internal enum Status {
        /// Cancelled
        ...
        /// Interrupted
        internal static let interrupted = ScreenshotL10n.tr("Localizable", "transcribe.status.interrupted", fallback: "Interrupted")
        /// Partially failed
        internal static let partiallyFailed = ScreenshotL10n.tr("Localizable", "transcribe.status.partially_failed", fallback: "Partially failed")
        /// Running
      ...
      internal enum StatusBar {
        /// Idle
        internal static let idle = ScreenshotL10n.tr("Localizable", "transcribe.status_bar.idle", fallback: "Idle")
        /// %d jobs
        internal static func jobsCount(_ p1: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "transcribe.status_bar.jobs_count", p1, fallback: "%d jobs")
        }
        /// Running segment %d / %d
        internal static func running(_ p1: Int, _ p2: Int) -> String {
          return ScreenshotL10n.tr("Localizable", "transcribe.status_bar.running", p1, p2, fallback: "Running segment %d / %d")
        }
      }
    }
    internal enum Transcription {
    ...
    internal enum Updates {
      internal enum Prompt {
        ...
        internal static let communityPromo = ScreenshotL10n.tr("Localizable", "updates.prompt.community_promo", fallback: "If you encounter any issues during use, please add WeChat: counterxing, or submit an issue on GitHub and leave your contact information. We will contact you as soon as possible and help you resolve the issue.")
        /// Current version:
